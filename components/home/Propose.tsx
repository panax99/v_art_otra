...
function Propose(){
    return(
        <>
        <div style={{background:'ghostwhite',marginTop:'35px',marginBottom:'45px'}}>
            ...
            <div className="jumbotron" style={{marginLeft:'675px',marginTop:'-360px'}}>
                ...
                <button className="btn btn-dark" style={{marginLeft:'215px',marginTop:'-53px'}}>Send Feedback</button>
            </div>
        </div>
        </>
    )
