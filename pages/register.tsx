...
function Register(){
    return(
        ...
        <div className="bg-gradient-primary"  style={{background:'rgb(221, 221, 221)'}}>
            <div className="container">
                <div className="card shadow-lg o-hidden border-0 my-5" style={{background:"rgb(255, 255, 255)"}} >
                    <div className="card-body p-0">
                        <div className="row">
                            <div className="col-lg-5 d-none d-lg-flex">
                                <div className="flex-grow-1 bg-register-image" style={{backgroundImage:"url(&quot;assets/img/dogs/pavel-nekoranec-I__QKQLMIKs-unsplash.jpg&quot;);"}}></div>
                            </div>
                            <div className="col-lg-7">
                                <div className="p-5">
                                    ...
                                    <form className="user">
                                        ...
                                        </div><button className="btn btn-primary d-block btn-user w-100" style={{backgroundColor: 'black'}} type="submit">Confirmer</button>
                                        <hr/>
                                            <a className="btn btn-primary d-block btn-google btn-user w-100 mb-2" style={{backgroundColor: 'brown'}} role="button">
                                                <i className="fab fa-google"></i>&nbsp; Enregistre avec Google
                                            </a>
                                            <a className="btn btn-primary d-block btn-facebook btn-user w-100 bt_enregistrer" style={{backgroundColor: 'blue'}} role="button">
